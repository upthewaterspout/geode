...
public class StatSamplerStats {
  ...
  public final static String SAMPLE_CALLBACK_DURATION = "sampleCallbackDuration"; // int
    ...
    samplerType = f.createType("StatSampler",
                               ...
                               new StatisticDescriptor[] {
                                 ...
                                 f.createIntCounter(JVM_PAUSES,
                                                    ...
                                                    "jvmPauses", false),
                                 f.createIntCounter(SAMPLE_CALLBACKS,
                                 ...
                                 f.createIntCounter(SAMPLE_CALLBACK_ERRORS,
                                   ...
                                   "errors", false),
                                 f.createIntCounter(SAMPLE_CALLBACK_DURATION,
                                   "Total amoount of time invoking sampling callbacks",
                                   "milliseconds", false),
                               });
