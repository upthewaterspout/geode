 ...
 *
 */
public class MultiProcessNodeManager implements ProcessManager {
  ...
  public MultiProcessNodeManager(int namingPort, Registry registry) {
    this.namingPort = namingPort;
    this.registry = registry;
  }

  @Override public synchronized void launchVM(int vmNum) throws IOException {
  ...
  @Override public synchronized void killVMs() {
  ...
  @Override public synchronized boolean hasLiveVMs() {
    for (ProcessHolder process : processes.values()) {
  ...
  @Override public synchronized void bounce(int vmNum) {
    if (!processes.containsKey(vmNum)) {
  ...
  @Override public synchronized boolean waitForVMs(long timeout) throws InterruptedException {
