 ...
 *
 * This class contains common logic for downloading and configuring J2EE containers
 * with cargo, and some common methods for applying geode session replication configuration
 * to those containers.
 *
...
public abstract class ContainerInstall {
  ...
  /**
   * Configure the geode session replication install in this container
   * to connect to the given locator.
   */
   ...
   * {@link GenericAppServerInstall} this war is modified to include the
   * geode session replication components.
   */
   ...
   * @param tagId The id of tag to edit. If null, then this method will add a new xml element, unless
   * writeOnSimilarAttributeNames is set to true.
   ...
   * attributes as the attributes parameter, and modifies the attributes of that element, rather
   * than adding a new element. If false, create a new XML element (unless tagId is not null).
   */
  protected void editXMLFile(String XMLPath, String tagId, String tagName, String parentTagName,
      HashMap<String, String> attributes, boolean writeOnSimilarAttributeNames) throws Exception {
