...
public class LuceneQueriesIntegrationTest extends LuceneIntegrationTest {
  ...
  public void shouldNotTokenizeWordsWithKeywordAnalyzer() throws ParseException {
    ...
    String tokenizedByStandardAnalyzer = "one three";
    String tokenizedByStandardAnalyzer2 = "one two three";
    region.put("A", new TestObject(tokenizedByStandardAnalyzer, tokenizedByStandardAnalyzer));
    region.put("B", new TestObject(tokenizedByStandardAnalyzer2, tokenizedByStandardAnalyzer2));
